...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="1024px" >
         <tr>
           <td colspan="8" align="left" style="color: #FFFFFF" bgcolor="#444" class="style1">
   ...
   <table cellpadding="0" cellspacing="2" width="1024px" style="border:4px solid #444" border="0">   
        <tr>
          ...
          <td align="left" class="style37">
              <asp:Label ID="TxtData" runat="server" Text="Data Rifornimento dal/Al" CssClass="testo_bold"></asp:Label>
           </td>  
          <td align="left" class="style37">
        ...
        <tr>
          ...
          <td align="left" class="style4">
              <a onclick="Calendar.show(document.getElementById('<%=TxtDataDal.ClientID%>'), '%d/%m/%Y', false)">
               <asp:TextBox ID="TxtDataDal" runat="server" Width="85px"></asp:TextBox></a>
           <%--    <asp:CalendarExtender ID="TxtDataDal_CalendarExtender" runat="server" Format="dd/MM/yyyy" 
              ...
              <a onclick="Calendar.show(document.getElementById('<%=TxtDataAl.ClientID%>'), '%d/%m/%Y', false)">
               <asp:TextBox ID="TxtDataAl" runat="server" Width="85px"></asp:TextBox></a>
                   ...
                   <ItemTemplate>
                      <tr style="background-color:#DCDCDC;color: #000000;">
                          <td>
                            ...
                            <asp:Label ID="num_rif" runat="server" CssClass="testo_piccolo" Text='<%# Eval("id") %>'/>
                          </td>
                          <td>
                              <asp:Label ID="lblFornitore" runat="server" Text='<%# Eval("fornitore") %>' CssClass="testo_piccolo"  />                              
                          </td> 
                          <td>
                              <asp:Label ID="idLabel" runat="server" Text='<%# Eval("id") %>' Visible="false" />
                              <asp:Label ID="targaLabel" runat="server" Text='<%# Eval("targa") %>' CssClass="testo_piccolo" />                              
                          </td>
                          <td>
                              <asp:Label ID="modelloLabel" runat="server" Text='<%# Eval("descrizione") %>' CssClass="testo_piccolo"  />                              
                          </td>                                                    
                          <td>
                              <asp:Label ID="alimentazioneLabel" runat="server" Text='<%# Eval("alimentazione") %>' CssClass="testo_piccolo" />                                                            
                          </td>
                          <td>
                              <asp:Label ID="dataRifLabel" runat="server" Text='<%# Eval("data_uscita_parco") %>' CssClass="testo_piccolo" />
                          </td>
                           <td>
                               <asp:Label ID="serbatoioLabel" runat="server" Text='<%# Eval("serbatoio") %>' CssClass="testo_piccolo" />                                                            
                               <asp:Label ID="Label118" runat="server" Text='/'  CssClass="testo_piccolo" />
                               <asp:Label ID="capicitaserbatoioLabel" runat="server" Text='<%# Eval("capacita_serbatoio") %>' CssClass="testo_piccolo" /> 
                              
                          </td>                              
                          <td>
                              <asp:Label ID="kmOutLabel" runat="server" Text='<%# Eval("km_out") %>' CssClass="testo_piccolo" />
                          </td>  
                          <td>
                              <asp:Label ID="Label1" runat="server" Text='<%# Eval("data_rientro_parco") %>' CssClass="testo_piccolo" />
                          </td>                        
                          <td>
                              <asp:Label ID="kmInLabel" runat="server" Text='<%# Eval("km_in") %>' CssClass="testo_piccolo" />
                          </td>  
                          <td>
                              <asp:Label ID="importoLabel" runat="server" Text='<%# Eval("importo_rifornimento") %>' CssClass="testo_piccolo" />
                          </td>  
                          <td>
                              <asp:Label ID="disponibile_nolo" runat="server" Text='<%# Eval("disponibile_nolo") %>' CssClass="testo_piccolo" />
                          </td>                                           
                          <td align="center">
                                  ...
                                  <table ID="itemPlaceholderContainer" runat="server" border="1" width="100%"  
                                      ...
                                      <tr id="Tr2" runat="server" style="color: #FFFFFF" bgcolor="#19191b">
                                          <th id="Th12" runat="server" align="left">
                                              <asp:LinkButton ID="LinkButton31" runat="server" CommandName="order_by_num_rif" CssClass="testo_titolo">Num.ID</asp:LinkButton>
                                          </th>
