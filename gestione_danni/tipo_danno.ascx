<%@ Control Language="VB" AutoEventWireup="false" CodeFile="tipo_danno.ascx.vb" Inherits="gestione_danni_tipo_danno" %>

<div id="div_intestazione" runat="server" visible="false">
    <table border="0" cellpadding="0" cellspacing="0" width="100%" >
         <tr>
           <td  align="left" style="color: #FFFFFF;background-color:#444;">
             <b>&nbsp;Veicoli - Gestione Tipo Danno</b>
           </td>
         </tr>
    </table>
</div>
...
<div id="div_modifica_tipo_danno" runat="server" visible="false">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" runat="server" id="table3">
    <tr>
      <td>
        <asp:Label ID="lb" runat="server" Text="Tipo danno:" CssClass="testo_bold"></asp:Label>
