<%@ Control Language="VB" AutoEventWireup="false" CodeFile="tipo_motivo_non_addebito.ascx.vb" Inherits="gestione_danni_tipo_motivo_non_addebito" %>

<div id="div_intestazione" runat="server" visible="false">
    <table border="0" cellpadding="0" cellspacing="0" width="100%" >
         <tr>
           <td  align="left" style="color: #FFFFFF;background-color:#444;">
             <b>&nbsp;Veicoli - Gestione Motivi Non Addebito Danno</b>
           </td>
         </tr>
    </table>
</div>

<div id="div_elenco_tipo_motivo_non_addebito" runat="server" visible="false">
  <table width="100%" cellpadding="0" cellspacing="0" runat="server" id="table2">
    <tr>
      <td>
          <asp:ListView ID="listViewElenco" runat="server" DataSourceID="sqlElenco">
              <ItemTemplate>
                  <tr style="background-color:#DCDCDC; color: #000000;">
                      ...
                      <td align="center" width="40px">
                        <asp:ImageButton ID="Elimina" runat="server" ImageUrl="/images/elimina.png" style="width: 16px" CommandName="Elimina"  OnClientClick="javascript: return(window.confirm('Confermi la cancellazione del tipo danno?'));" />
                      </td>
                  </tr>
              </ItemTemplate>
...
<div id="div_modifica_tipo_motivo_non_addebito" runat="server" visible="false">
  <br />
  <table width="100%" cellpadding="0" cellspacing="0" runat="server" id="table3">
    <tr>
      <td>
        <asp:Label ID="lb" runat="server" Text="Tipo Motivi Non Addebito Danno:" CssClass="testo_bold"></asp:Label>
...
<asp:SqlDataSource ID="sqlElenco" runat="server" 
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
    ControlToValidate="tx_descrizione" ErrorMessage="Specificare il tipo motivo del non addebito del danno." 
