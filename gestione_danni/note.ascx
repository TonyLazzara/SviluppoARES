<%@ Control Language="VB" AutoEventWireup="false" CodeFile="note.ascx.vb" Inherits="gestione_danni_note" %>
    ...
    <table border="0" cellpadding="0" cellspacing="2" width="100%" style="border:4px solid #444">
        ...
        <tr>
            <td id="Td11" runat="server" >
              <asp:TextBox ID="tx_nota" runat="server" Width="500px" Height="85px" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
    <tr>
        <td>
