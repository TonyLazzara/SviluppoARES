...
<ajaxtoolkit:TabPanel ID="Tab_documenti" runat="server" HeaderText="Documenti">
   ...
   <table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td align="left" style="color: #FFFFFF" bgcolor="#369061"><b>Documenti allegati alla gestione del RDS</b> </td></tr></table>
         ...
         <asp:ListView ID="listViewDocumenti" runat="server" 
              ...
              <ItemTemplate>
                  <tr style="background-color:#DCDCDC; color: #000000;">
                      ...
                      <td id="Td17" align="center" width="40px" runat="server" >
                          <asp:Label ID="lbl_datacreazione" runat="server" Text='<%# Eval("data_creazione") %>' Visible="true" />
                      </td>
                      <td id="Td19" align="center" width="40px" runat="server" >
                          <asp:Label ID="lbl_operatore" runat="server" Text='<%# Eval("operatore") %>' Visible="true" />
                      </td>                   
                      <td id="Td2" align="center" width="40px" runat="server" >
                        ...
                        <a id="doc_altro" href="/images/DocDanni/<%# Eval("riferimento_foto") %>" target="_blank" >
                        <img src="/images/lente.png" style="width: 16px" /></a>
                      </td>                      
                      ...
                      <td align="center">
                        <asp:CheckBox ID="chkAllegatoEmail" runat="server" Text="" Width="15px"/>
                     </td>
                  </tr>
              </ItemTemplate>            
              <AlternatingItemTemplate>
                                            ...
                                            <td id="Td1" runat="server">
                                                <table ID="itemPlaceholderContainer" runat="server" border="1" style="background-color: #FFFFFF;border-collapse: collapse;border-color: #999999;border-style:none;border-width:0px;font-family: Verdana, Arial, Helvetica, sans-serif;" width="100%">
                                                    <tr id="Tr3" runat="server" style="color: #FFFFFF" class="sfondo_rosso">
                                                        ...
                                                        <th id="Th11" style="text-align:center;width:160px;" runat="server">Data e Ora</th>
   ...
   <br />
   <table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td align="left" style="color: #FFFFFF" bgcolor="#369061"><b>Lista Mail Inviate</b> </td></tr></table>
   <table width="100%" cellpadding="0" cellspacing="0" runat="server" id="table10">   
      <tr id="Tr11" runat="server">
        <td id="Td20" colspan="2" runat="server">
          <asp:ListView ID="listViewMailInviate" runat="server" DataSourceID="sqlRDSMailInviate" DataKeyNames="id">
              <ItemTemplate>
                  <tr style="background-color:#DCDCDC; color: #000000;">
                      <td>   
                          <asp:Label ID="lb_id" runat="server" Text='<%# Eval("id") %>' Visible="false" />                       
                          <asp:Label ID="lb_data" runat="server" Text='<%# Eval("data") %>' />                          
                      </td> 
                      <td>                          
                            <asp:Label ID="lb_destinatario" runat="server" Text='<%# Eval("destinatario") %>' />                        
                      </td> 
                      <td>
                            <asp:Label ID="Label56" runat="server" Text='<%# Eval("allegati_inviati") %>' />                        
                      </td>  
                      <td id="Td17" align="center" width="40px" runat="server" >
                ...
                <table id="Table2" runat="server" width="100%">
                    <tr id="Tr1" runat="server">
                        <td id="Td1" runat="server">
                            <table ID="itemPlaceholderContainer" runat="server" border="1" style="background-color: #FFFFFF;border-collapse: collapse;border-color: #999999;border-style:none;border-width:0px;font-family: Verdana, Arial, Helvetica, sans-serif;" width="100%">
                                <tr id="Tr3" runat="server" style="color: #FFFFFF" class="sfondo_rosso">                                    
                                    <th id="Th2" style="width:100px; text-align:center;" runat="server">Data Invio</th>
                                    <th id="Th3" style="width:180px;" runat="server">Destinatario</th>
                                    <th id="Th11" runat="server">Allegati Inviati</th>
                                    <th id="Th4" style="text-align:center;width:150px;" runat="server">Operatore</th>
                                    <%--<th id="Th5" style="width:25px; text-align:center;" runat="server"></th>--%>
                                </tr>
        ...
        <tr>
            ...
            <td align="left">
                <asp:DropDownList ID="DropOperazione" runat="server">
                    <asp:ListItem Value="0" Selected="True">Seleziona...</asp:ListItem>                                     
                    <asp:ListItem Value="6">Addebitato</asp:ListItem>
                    ...
                    <%--<asp:ListItem Value="7">Fatturato</asp:ListItem>--%>
                </asp:DropDownList>
                <!-- Tony  17-04-2023 -->
                &nbsp;&nbsp;<asp:CheckBox ID="chkDaRiparare" runat="server" Text="Da Riparare"></asp:CheckBox>
                <asp:Label ID="lb_operazione" runat="server" CssClass="testo_bold" Visible="False" Font-Bold="True" BorderColor="Red"></asp:Label>                
                <!-- FINE 09-05-2023 -->
            </td>
            <td align="right" style="width:50%">
                <a id="A2" href="/gestione_danni/SelezionaLetteraRDS.aspx?id_evento=<%= lb_id_evento.text %>&id_evento_apertura=<%= lb_num_documento.text %>" rel="lyteframe" 
                ...
                <%--<asp:Button ID="bt_stampa_lettera" runat="server" Text="Stampa Lettera2" />--%>
            ...
            <td colspan="3">
                ...
                <table border="0" cellpadding="0">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label20" runat="server" Text="Per ufficio manutenzione" CssClass="testo_bold" Visible="False"></asp:Label>&nbsp; 
                            <asp:DropDownList ID="Drop_manutenzione" runat="server" AppendDataBoundItems="True" 
                                DataSourceID="Sql_manutenzione" DataTextField="descrizione" DataValueField="id" Visible="False">
                                <asp:ListItem Value="0" Selected="True">Seleziona...</asp:ListItem>
                            </asp:DropDownList>&nbsp;&nbsp;
                            <asp:Label ID="Label21" runat="server" Text="Per" CssClass="testo_bold"></asp:Label>
...
<asp:Label ID="lb_id_stato_rds" runat="server" Text='0' visible="true"></asp:Label>
...
<asp:SqlDataSource ID="sqlDocumenti" runat="server" 
        ...
        SelectCommand="SELECT vdf.*, td.descrizione des_tipo_documento
            ...
            WHERE vdf.id_evento = @id_evento ORDER BY td.ordine, vdf.data_creazione desc">
        <SelectParameters>
            <asp:ControlParameter ControlID="lb_id_evento" Name="id_evento" PropertyName="Text" Type="Int32" />
        </SelectParameters>
</asp:SqlDataSource>
...
<asp:SqlDataSource ID="SqlRDSMailInviate" runat="server" 
        ConnectionString="<%$ ConnectionStrings:SicilyConnectionString %>" 
        SelectCommand="SELECT * FROM [RDS_mail_inviate] WITH(NOLOCK) ORDER BY data desc">
</asp:SqlDataSource>
