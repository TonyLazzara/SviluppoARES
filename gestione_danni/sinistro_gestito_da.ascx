<%@ Control Language="VB" AutoEventWireup="false" CodeFile="sinistro_gestito_da.ascx.vb" Inherits="gestione_danni_sinistro_gestito_da" %>
...
<tr>
  <td class="style3">
      <asp:Label ID="lblGestitoDa" runat="server" Text="Sinistro Gestito Da:" CssClass="testo_bold"></asp:Label></td>
  <td class="style4">
  
      <asp:TextBox ID="txtGestitoDa" runat="server" Width="126px" MaxLength="50"></asp:TextBox>
...
<table border="0" cellpadding="1" cellspacing="1" width="1024px" >
 <tr>
   <td>
     <asp:ListView ID="listGestitoDa" runat="server" DataKeyNames="id" DataSourceID="sqlGestitoDa" Visible="false">
                   <ItemTemplate>
