...
Public Class WebServiceFunzioniTest

    'questa è la sola funzione esposta in WebMethod

    Public Function getElencoVeicoli(ByVal stazione_inizio_noleggio As String, ByVal data_inizio_noleggio As String,
                                            ByVal ora_inizio_noleggio As String, ByVal stazione_fine_noleggio As String,
                                            ByVal data_fine_noleggio As String, ByVal ora_fine_noleggio As String,
                                            ByVal eta As String, ByVal id_tip_cliente As Integer,
                                            ByVal lingua As String, ByVal cod_promo As String) As String


        'getElencoVeicoli = "prova" 'test
        'Exit Function  'test
                            ...
                            Else
                                ...
                                Do While Rs2.Read()
                                    ...
                                    If (id_tariffe_righe & "") <> "" Or (id_tariffe_righe_prep & "") <> "" Then
                                        ...
                                        'dictionary.Add("@tipotariffa", tipoTariffa)
    ...
    Public Function get_tariffa_x_righe_prepagato(ByVal data_uscita As String, ByVal data_rientro As String, ByVal giorni_nolo As String, ByVal stazione As String, ByVal stazioneOff As String, ByVal IdTipCliente As Integer, ByVal cod_promo As String) As String
        Dim Risultato, RisultatoParticolare As String
    ...
    Public Function calcolaTariffa_x_gruppo(ByVal stazione_pick_up As String, ByVal data_pick_up As String, ByVal ore_pick_up As Integer,
        ...
        ElseIf prepagata And giorni_prepagati_x_modifica = 0 Then
            ...
            'prepagato_memorizza_costi_prepagati_x_fattura(id_prenotazione, id_ribaltamento, id_contratto, id_gruppo, num_calcolo, "")                      'questo su fuonzioni
    ...
    Protected Function calcola_tempo_km(ByVal giorni_noleggio As Integer, ByVal giorni_prepagati As Integer, ByVal prepagata As Boolean,
                ...
                If valore <> 0 Then
                    ...
                    Else
                        ...
                        If packed = "False" Then
                            ...
                            If FlagOldCalcolo = False Then
                                valore = funzioni_comuni_new.GetNewTariffaTempoKmPeriodi(stazione_pick_up, stazione_drop_off, dataPickUp, dataDropOff,
                                                                                     tipoCli, id_gruppo, TipoTariffa, descTariffa, giorni_noleggio, idTariffa, False, "", "", max_sconto_new) 'nuovo calcolo senza periodi 06.12.2022
                            Else
