...
<WebService(Namespace:="http://sviluppo.sicilyrentcar.it/")>
<WebServiceBinding(ConformsTo:=WsiProfiles.BasicProfile1_1)> _
<Global.Microsoft.VisualBasic.CompilerServices.DesignerGenerated()> _
Public Class WebServiceSviluppoBooking
    ...
    Public Function HelloWorld() As String
        Return "Hello World in sviluppo "
    End Function
    ...
    Public Function getListaExtra(ByVal IdPrepagato As String, ByVal lingua As String) As String
        Try
            ...
            'dictionary = New Dictionary(Of String, String)(1)
            'dictionary.Add("SQL:", CmdExtra.CommandText)
            'list.Add(dictionary)
    ...
    Public Function getListaFranchigie(ByVal Id As String, ByVal lingua As String) As String
        Try
            ...
            'dictionary = New Dictionary(Of String, String)(1)
            'dictionary.Add("SQL:", CmdFranchiggie.CommandText)
            'list.Add(dictionary)
