...
<WebService(Namespace:="http://ares.sicilyrentcar.it/")>
<WebServiceBinding(ConformsTo:=WsiProfiles.BasicProfile1_1)>
<Global.Microsoft.VisualBasic.CompilerServices.DesignerGenerated()>
Public Class WebServiceBookingTest
    ...
    Public Function getElencoVeicoli(ByVal stazione_inizio_noleggio As String, ByVal data_inizio_noleggio As String,
            ByVal ora_inizio_noleggio As String, ByVal stazione_fine_noleggio As String, ByVal data_fine_noleggio As String,
            ByVal ora_fine_noleggio As String, ByVal eta As String, ByVal id_tip_cliente As Integer, ByVal lingua As String, ByVal cod_promo As String) As String


        'riempie le session per la pagina successiva di richiesta GetListExtra '12.06.2021
        Session("stazione_inizio_noleggio") = stazione_inizio_noleggio
        Session("data_inizio_noleggio") = data_inizio_noleggio
        Session("ora_inizio_noleggio") = ora_inizio_noleggio
        Session("stazione_fine_noleggio") = stazione_fine_noleggio
        Session("data_fine_noleggio") = data_fine_noleggio
        Session("ora_fine_noleggio") = ora_fine_noleggio
        Session("eta") = eta
        Session("id_tip_cliente") = id_tip_cliente
        Session("lingua") = lingua
        Session("cod_promo") = cod_promo
                            ...
                            Else
                                ...
                                Do While Rs2.Read()
                                    ...
                                    If (id_tariffe_righe & "") <> "" Or (id_tariffe_righe_prep & "") <> "" Then
                                        ...
                                        'TEST
                                        'da rimuovere x verificare tempi risposta 10.06.2021
                                        Id_nuovo_preventivo = nuovo_preventivo()
                                        Id_nuovo_preventivo_prepagato = nuovo_preventivo_prepagato()

                                        Session("chiamata_sito_web") = True 'funzione chiamata dalla home page non registra su DB
        ...
        Try
            ...
            Do While Rs2.Read()
                ...
                If (id_tariffe_righe & "") <> "" Or (id_tariffe_righe_prep & "") <> "" Then
                    ...
                    dictionary.Add("Id Preventivo", Id_nuovo_preventivo)
                    dictionary.Add("Id Preventivo Prepagato", Id_nuovo_preventivo_prepagato)
                    dictionary.Add("Stazione Uscita", stazione_inizio_noleggio)
                    dictionary.Add("Data PikUp", data_inizio_noleggio)
                    dictionary.Add("Ora PikUp", ora_inizio_noleggio)
                    dictionary.Add("Minuti PikUp", minuti_inizio2)
                    dictionary.Add("Stazione Entrata", stazione_fine_noleggio)
                    dictionary.Add("Data DropOff", data_fine_noleggio)
                    dictionary.Add("Ora DropOff", ora_fine2)
                    dictionary.Add("Minuti DropOff", minuti_fine2)
                    dictionary.Add("Tariffa Riga", id_tariffe_righe)
                    dictionary.Add("Tariffa RigaPrepagata", id_tariffe_righe_prep)
    ...
    Public Function getListaExtra(ByVal IdPrepagato As String, ByVal lingua As String) As String
        ...
        'AGGIUNTO : session dalla pagina di GetElencoVeicoli 13.06.2021
        Dim stazione_inizio_noleggio As String = Session("stazione_inizio_noleggio")
        Dim data_inizio_noleggio As String = Session("data_inizio_noleggio")
        Dim ora_inizio_noleggio As String = Session("ora_inizio_noleggio")
        Dim stazione_fine_noleggio As String = Session("stazione_fine_noleggio")
        Dim data_fine_noleggio As String = Session("data_fine_noleggio")
        Dim ora_fine_noleggio As String = Session("ora_fine_noleggio")
        Dim eta As String = Session("eta")
        Dim id_tip_cliente As String = Session("id_tip_cliente")
        Dim cod_promo As String = Session("cod_promo")

        'inserita per richiamare la registrazione su db 12.06.2021
