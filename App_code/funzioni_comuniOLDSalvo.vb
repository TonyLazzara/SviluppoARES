...
Public Class funzioni_comuniOLDSalvo
    ...
    Public Shared Sub RefreshListAllegatiContratti(sqlcom As SqlDataSource, dtlist As ListView, status_co As String, id_contratto As String, numero_contratto As String)
        ...
        If status_co = "0" Then
            ...
            sqlcom.SelectCommand = "SELECT id_allegato, nome_file, cartella, (cartella + nome_file) as my_path, descrizione FROM contratti_prenotazioni_allegati WITH(NOLOCK) " &
    ...
    Public Shared Function AllegaContrattoDopoFirma(numcontratto As String, Optional tipo As String = "uscita") As Boolean
        ...
        Try
            ...
            If File.Exists(newFile) = True Then
                ...
                Dim insertAllegati As Boolean = insertContrattoPDFtoAllegati("/allegati_pren_cnt/" & numcontratto & "/", numcontratto, tipo)
                ris = insertAllegati
    ...
    Public Shared Function insertContrattoPDFtoAllegati(ByVal pathAllegato As String, ByVal contratto_num As String, Optional tipo As String = "uscita") As Boolean
        Dim ris As Boolean = False
    ...
    Private Function salvaRigaCalcolo(ByVal id_preventivo As String, ByVal id_ribaltamento As String, ByVal id_prenotazione As String, ByVal id_contratto As String, ByVal num_calcolo As String, ByVal id_gruppo As String, ByVal id_elemento As String, ByVal num_elemento As String, ByVal nome_costo As String, ByVal valore_costo As String, ByVal valore_percentuale As String, ByVal aliquota_iva As String, ByVal codice_iva As String, ByVal iva_inclusa As String, ByVal scontabile As String, ByVal omaggiabile As String, ByVal acquistabile_nolo_in_corso As String, ByVal id_a_carico_di As String, ByVal id_metodo_stampa As String, ByVal obbligatorio As String, ByVal selezionato As String, ByVal ordine_stampa As Integer, ByVal franchigia_attiva As String, ByVal id_unita_misura As String, ByVal km_giorno_inclusi As String, ByVal packed As String, ByVal qta As String, ByVal data_aggiunta_nolo_in_corso As String, ByVal restituire_id As Boolean, ByVal prepagata As Boolean) As String
    ...
    Protected Function get_elemento_fuori_orario_pickUp(ByVal ore_pick_up As Integer, ByVal minuti_pick_up As Integer) As String
    ...
    Protected Sub calcola_tempo_km(ByVal giorni_noleggio As Integer, ByVal giorni_prepagati As Integer, ByVal prepagata As Boolean, ByVal giorni_noleggio_extra_rack As Integer, ByVal sconto_su_rack As String, ByVal stazione_pick_up As String, ByVal stazione_drop_off As String, ByVal id_tempo_km_figlia As String, ByVal id_tempo_km_rack As String, ByVal id_gruppo As String, ByVal id_gruppo_da_prenotazione_x_modifica_con_rack As String, ByVal id_preventivo As String, ByVal id_ribaltamento As String, ByVal id_prenotazione As String, ByVal id_contratto As String, ByVal num_calcolo As String, ByVal broker_a_carico_di As String)
    ...
    Public Sub calcolaTariffa_x_gruppo(ByVal stazione_pick_up As String, ByVal data_pick_up As String, ByVal ore_pick_up As Integer, ByVal minuti_pick_up As Integer, ByVal stazione_drop_off As String, ByVal id_tariffe_righe As String, ByVal id_gruppo As String, ByVal id_gruppo_da_prenotazione_x_modifica_con_rack As String, ByVal giorni_noleggio As Integer, ByVal giorni_prepagati_x_modifica As String, ByVal prepagata As String, ByVal giorni_noleggio_extra_rack As Integer, ByVal sconto As Double, ByVal tipo_sconto As String, ByVal sconto_web_prepagato_primo_calcolo As Double, ByVal sconto_su_rack As Double, ByVal eta_primo_guidatore As String, ByVal eta_secondo_guidatore As String, ByVal id_preventivo As String, ByVal id_ribaltamento As String, ByVal id_prenotazione As String, ByVal id_contratto As String, ByVal num_calcolo As String, ByVal id_utente As String, ByVal id_ditta As String, ByVal id_fonte_commissionabile As String, ByVal commissione_percentuale As String, ByVal tipo_commissione As String, ByVal primo_calcolo_commissione As Boolean, ByVal giorni_commissioni_originale As String, Optional ByVal broker_a_carico_di As String = "")
