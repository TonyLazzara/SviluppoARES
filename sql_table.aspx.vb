...
Partial Class sql1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim Sql As String = "SELECT id, id_stazione, id_orario, da_mese, a_mese, da_giorno, a_giorno FROM stazione_orari WHERE (id_stazione = 2) OR (id_stazione = 4) ORDER BY id_stazione, id_orario"
        Sql = "SELECT * FROM stazioni ORDER BY id"
