<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageNoMenuX.master" AutoEventWireup="false" CodeFile="prenotazioni.aspx.vb" Inherits="prenotazioni" 
...
<tr>
  ...
  <tr>
    <td  colspan="10" align="center" style="color: #FFFFFF;background-color:#444;" 
        ...
        <asp:Label ID="lbl_data_out_originale" runat="server"  CssClass="testo_titolo" Visible="false"></asp:Label> <%--aggiunto 11.01.2023 salvo x verifica calcolo --%>
    </td>
  </tr>
<tr>
  ...
  <td class="style15" valign="top">
        <asp:DropDownList ID="dropStazionePickUp" runat="server" OnSelectedIndexChanged="dropStazionePickUp_SelectedIndexChanged" AutoPostBack="true" 
      ...
      <asp:Label ID="lbl_StazionePickUp_OLD" runat="server" Visible="true"></asp:Label>
  </td>
  <td valign="top" class="style18">
    ...
    <asp:TextBox runat="server" Width="80px" ID="txtDaData" onchange="copia_data();"></asp:TextBox>
          </a>
      <asp:Label ID="txtOldDaData" runat="server" Visible="false"></asp:Label>
      <asp:Label ID="lbl_DaData_Old" runat="server" Visible="true"></asp:Label> <%--nuovo salvo--%>
  ...
  <td class="style42" valign="top">
      ...
      <%--salvo 24.02.23--%>
          <asp:label ID="lbl_DaOre_Old" runat="server" Visible="true"></asp:label>
          <asp:label ID="lbl_DaMinuti_Old" runat="server" Visible="true"></asp:label>
...
<tr>
  ...
  <td class="style15" valign="top">
    ...
    <asp:Label ID="OldStazioneDropOff" runat="server" Visible="false"></asp:Label>
      <asp:Label ID="lbl_stazioneDropOff_OLD" runat="server" Visible="true"></asp:Label>
  </td>
  <td class="style18" valign="top">
    ...
    <asp:TextBox runat="server" Width="80px" ID="txtAData" ></asp:TextBox>
      ...
      <asp:Label ID="lbl_AData_old" runat="server" Visible="true"></asp:Label>
  ...
  <td class="style42" valign="top">
    ...
    <asp:TextBox ID="minuti2" runat="server" Width="29px" MaxLength="2" Visible="false"></asp:TextBox>
       ...
       <%--salvo 24.02.23--%>
          <asp:label ID="lbl_AOre_old" runat="server" Visible="true"></asp:label>
          <asp:label ID="lbl_AMinuti_old" runat="server" Visible="true"></asp:label>
...
<tr>
  ...
  <td valign="top" class="style53">
    ...
    <%--Salvo 24.02.2023--%>
      <asp:Label ID="lbl_numeroGiorni_old" runat="server" Visible="true"></asp:Label>
       <asp:Label ID="lbl_valore_tariffa_ori" runat="server" Visible="true"></asp:Label>
  ...
  <td valign="top">      
      ...
      <asp:Label ID="lblGiorniToOld" runat="server" visible="true"></asp:Label>
  ...
  <td valign="top">  
       ...
       <asp:Label ID="lbl_gruppo_old" runat="server" Text="" visible="false"></asp:Label>
    </td>
...
<tr>
  <td align="left" valign="top" runat="server" id="colonna_list_prenotazioni">
    <asp:Label ID="lbl_Importo_Sconto" runat="server" Text="" Visible="true"></asp:Label>
        ...
        <asp:ListView ID="ListViewAllegati" runat="server" DataSourceID="sqlAllegati" DataKeyNames="Id_allegato" >
            <ItemTemplate>
                <tr style="background-color:#FFFFFF; color: #000000; ">                    
                    ...
                    <td style="text-align:center;"><asp:Label ID="lbl_operatore" runat="server" Text='<%# Eval("id_operatore") %>'></asp:Label></td>
                        ...
                        <td id="Td1" runat="server">
                            <table ID="itemPlaceholderContainer" runat="server" border="1" style="background-color: #FFFFFF;border-collapse: collapse;border-color: #999999;border-style:none;border-width:0px;font-family: Verdana, Arial, Helvetica, sans-serif;" width="100%">
                                <tr id="Tr3" runat="server" style="color: #FFFFFF;background-color:#000000;" >
                                    ...
                                    <th id="Th2" runat="server" style="width:250px;">Tipo</th>
                                    <th id="Th3" runat="server">Nome File</th>
                                    <%--<th id="Th4" runat="server">Percorso File</th>--%>
                                    <th id="Th23" runat="server">Data e ora</th>
                                    <th id="Th7" runat="server">Operatore</th>
            ...
            <SelectedItemTemplate>
                <tr style="">
                    ...
                    <%--<td><asp:Label ID="lblPercorsoFile" runat="server" Width="180px" Font-Size="X-Small" Text='<%# Eval("my_path") %>'></asp:Label></td>--%>
                     <td><asp:Label ID="lbl_data_caricamento" runat="server" Text='<%# Eval("data_operazione") %>'></asp:Label></td>
                    <td><asp:Label ID="lbl_operatore" runat="server" Text='<%# Eval("id_allegato") %>'></asp:Label></td>
                    <td align="center"><asp:ImageButton ID="SelezionaAllegato" runat="server" ImageUrl="/images/lente.png" style="width: 16px" CommandName="SelezionaAllegato"/></td>
...
&nbsp;<asp:Label ID="idPrenotazione" runat="server" Visible="false"></asp:Label>
      ...
      <asp:Label ID="ricalcolaPrepagato" runat="server" Visible="true" Text=""></asp:Label>
