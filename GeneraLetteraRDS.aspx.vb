...
Partial Class GeneraLetteraRDS
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ' recuper il parametri di stampa dalla Session!
            Dim mie_dati As DatiStampaLetteraRDS = Session("DatiStampaLetteraRDS")
            Session("DatiStampaLetteraRDS") = Nothing
            If mie_dati Is Nothing Then
                mie_dati = New DatiStampaLetteraRDS
                With mie_dati
            ...
            Dim ms As MemoryStream = StampaLetteraRDS.GeneraDocumento(mie_dati)
