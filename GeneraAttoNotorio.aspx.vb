...
Partial Class GeneraAttoNotorio
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ' recuper il parametri di stampa dalla Session!
            Dim mie_dati As DatiStampaAttoNotorio = Session("DatiStampaAttoNotorio")
            Session("DatiStampaAttoNotorio") = Nothing
            If mie_dati Is Nothing Then
                mie_dati = New DatiStampaAttoNotorio
                With mie_dati
            ...
            Dim ms As MemoryStream = StampaAttoNotorio.GeneraDocumento(mie_dati)
