<%@ Page Language="VB" MasterPageFile="MasterPageNoMenuX.master" AutoEventWireup="false" CodeFile="tabelle_posTony.aspx.vb" Inherits="tabelle_posTony" title="" %>
...
<table style="color: #FFFFFF" bgcolor="#215A87" width="1024px">
      <tr>
         <td >
            ...
            <%--65--%>
                <span style="white-space: nowrap;">
                <img src="punto_elenco.jpg" width="8" height="7" alt="Censimento Acquires" title="Censimento Acquires" runat="server" id="puntoCensimentoAcquires" />
            ...
            <%--66--%>
                <span style="white-space: nowrap;">
                <img src="punto_elenco.jpg" width="8" height="7" alt="Censimento Tipologie Errori" title="Censimento Tipologie Errori" runat="server" id="puntoCensimentoTipologieErrori" />
            ...
            <%--67--%>
                <span style="white-space: nowrap;">
                <img src="punto_elenco.jpg" width="8" height="7" alt="Censimento Action Code" title="Censimento Action Code" runat="server" id="puntoCensimentoActionCode" />
