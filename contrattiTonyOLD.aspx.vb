...
Partial Class contrattiTony
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack() Then
            ...
            If Session("id_contratto_from_prenotazioni") <> "" And Session("idPrenotazione") <> "" Then
                ...
                'attivato qui il ricalcola 02.03.2021
                'se proveniente da preventivi o da prenotazioni
                'richiama ricalcolo importi all'apertura della pagina 25.02.2021
            ...
            ElseIf Session("carica_contratto") <> "" Then
                ...
                If idContratto.Text <> "" Then
                    ...
                    'se status=8 deve verificare il campo firma rientro
                    If statoContratto.Text = "8" Then
                        getFirmaStatus = funzioni_comuni.GetContrattoFirmato("", idContratto.Text, "8")
                    Else
                        getFirmaStatus = funzioni_comuni.GetContrattoFirmato("", idContratto.Text)
                    End If
            ...
            If Rs.HasRows Then
                Do While Rs.Read
                    If Not IsDBNull(Rs("importo_prepagato")) Then       'aggiornato 15.06.2022 salvo
                        If Rs("importo_prepagato") & "" <> "" Then
                            If txtPOS_TotAbbuoni.Text & "" = "" Then
                                txtPOS_TotAbbuoni.Text = "0"
                            End If
                            lblDifferenzaDaPrenotazione.Text = FormatNumber(CDbl(Rs("valore_costo")) - CDbl(Rs("importo_prepagato")) - txtPOS_TotIncassato2.Text + txtPOS_TotAbbuoni.Text, 2, , , TriState.False)
                        End If
                    Else
                        ...
                        lblDifferenzaDaPrenotazione.Text = FormatNumber(CDbl(Rs("valore_costo")) - txtPOS_TotIncassato2.Text + txtPOS_TotAbbuoni.Text, 2, , , TriState.False)
                    End If
        ...
        If statoContratto.Text = "2" Or statoContratto.Text = "4" Or statoContratto.Text = "8" Then '09.02.2022
            'solo se Aperto(2) , chiuso da incassare (4), chiuso da fatturare (8)  

            If statoContratto.Text = "8" Then
                firmato = funzioni_comuni.GetContrattoFirmato(ncontratto, "", "8")
            Else
                firmato = funzioni_comuni.GetContrattoFirmato(ncontratto, "")
            End If
        ...
        ElseIf statoContratto.Text = "6" Then  'da fatturare
    ...
    Protected Sub listPagamenti_ItemCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ListViewCommandEventArgs) Handles listPagamenti.ItemCommand
        If e.CommandName = "vedi" Then
            ...
            Dim Dbc As New Data.SqlClient.SqlConnection(Web.Configuration.WebConfigurationManager.ConnectionStrings("SicilyConnectionString").ConnectionString)
            Dbc.Open()
            Dim Cmd As New Data.SqlClient.SqlCommand("SELECT per_importo as importo, nr_aut, cassa, titolo, intestatario, scadenza, id_operatore_ares, terminal_id, NR_PREAUT, scadenza_preaut, stazioni.codice, note FROM PAGAMENTI_EXTRA WITH(NOLOCK) LEFT JOIN stazioni WITH(NOLOCK) ON pagamenti_extra.id_stazione=stazioni.id WHERE ID_CTR='" & id_pagamento_extra.Text & "'", Dbc)
            ...
            If Rs.HasRows() Then
                ...
                If livello_accesso_eliminare_pagamenti.Text = 3 AndAlso getStatoContratto() <> Costanti.stato_contratto.fatturato Then
    ...
    Protected Function getStatoContratto() As String
        Dim sqla As String = "SELECT status FROM contratti WITH(NOLOCK) WHERE num_contratto='" & contratto_num.Text & "' AND attivo='1'"
        Try
            'RESTITUISCE LO STATO DEL CONTRATTO ATTUALE (QUINDI PARTENDO DAL NUMERO DI CONTRATTRO)
            Dim Dbc As New Data.SqlClient.SqlConnection(Web.Configuration.WebConfigurationManager.ConnectionStrings("SicilyConnectionString").ConnectionString)
            Dbc.Open()
    ...
    Protected Sub RicalcolaModificaContratto()
    ...
    Public Function PostFirmaInserita(ByVal id As String) As Boolean
        ...
        If funzioni_comuni.GetContrattoFirmato(numero_contratto, "") = False Then
            PostFirmaInserita = False
            Exit Function
        End If
    ...
    Protected Sub stampa_contratto(ByVal tipo As String, ByVal tipo_stampa As String)
        ...
        Try
            ...
            Else
                ...
                If funzioni_comuni.GetContrattoFirmato(numcontratto, "", statoContratto.Text) = True Then
                    ...
                    If statoContratto.Text = "8" Or statoContratto.Text = "4" Then
                        ...
                        line_err = 6
                        scki.Stampa_Check_In(tipo_documento.Contratto, numcontratto, 0, "f")
                        line_err = 7
                        'refresh allegati
            ...
            Try
                ...
                If broker = True Then
                    ...
                    If nazioneBroker = "16" Then
                        ...
                        corpoMessaggioBroker += "<br/><br/><a href='https://www.sicilyrentcar.it/'><img src='http://ares.sicilyrentcar.it/img/SRC_logo.jpg' style='text-align:left;width:150px;height:30px;' alt='' /></a>" & vbCrLf
                        ...
                        corpoMessaggioBroker += "<br/><a target='_blank' href='https://www.sicilyrentcar.it/'>www.sicilyrentcar.it</a>" & vbCrLf
                ...
                If idnazione = "16" Then 'se Italia 16
                    ...
                    corpoMessaggio += "<br/><br/><a href='https://www.sicilyrentcar.it/'><img src='http://ares.sicilyrentcar.it/img/SRC_logo.jpg' style='text-align:left;width:150px;height:30px;' alt='' /></a>" & vbCrLf
                ...
                Else
                    ...
                    If test = "" Then
                        ...
                        Else
                            ...
                            System.Threading.Thread.Sleep(1500)         'Ritarda di 1 secondi per attesa firma 14.06.2022 salvo
            ...
            Else
                If statoContratto.Text = "0" Then
                    ...
                    If UploadAllegati.HasFile Then
                        ...
                        Dim sqlall As String = "INSERT INTO contratti_prenotazioni_allegati (nome_file, cartella, id_cnt_provv, id_cnt_pren_allegati_tipo, nome_file_operatore) " &
                                                                 " VALUES ('" & nome_file & "','" & my_path & "','" & idContratto.Text & "'," & dropNuovoAllegato.SelectedValue & ",'" & nome_file_operatore & "')"
                        ...
                        While File.Exists(filePath & nome_file)
                            ...
                            sqlall = "INSERT INTO contratti_prenotazioni_allegati (nome_file, cartella, id_cnt_provv, id_cnt_pren_allegati_tipo, nome_file_operatore) " &
                                                                     " VALUES ('" & nome_file & "','" & my_path & "','" & idContratto.Text & "'," & dropNuovoAllegato.SelectedValue & ",'" & nome_file_operatore & "')"
                ...
                Else
                    ...
                    If UploadAllegati.HasFile Then
                        ...
                        Dim sqlall As String = "INSERT INTO contratti_prenotazioni_allegati (nome_file, cartella, num_cnt, id_cnt_pren_allegati_tipo, nome_file_operatore) " &
                                                                 " VALUES ('" & nome_file & "','" & my_path & "','" & lblNumContratto.Text & "'," & dropNuovoAllegato.SelectedValue & ",'" & nome_file_operatore & "')"
                        ...
                        While File.Exists(filePath & nome_file)
                            ...
                            sqlall = "INSERT INTO contratti_prenotazioni_allegati (nome_file, cartella, num_cnt, id_cnt_pren_allegati_tipo, nome_file_operatore) " &
                                                                     " VALUES ('" & nome_file & "','" & my_path & "','" & lblNumContratto.Text & "'," & dropNuovoAllegato.SelectedValue & ",'" & nome_file_operatore & "')"
    ...
    Protected Sub btn_inviamail_Click(sender As Object, e As EventArgs)
        ...
        If GetContrattoFirmato(contratto_num.Text, "") = False Then
        ...
        Try
            ...
            Try
                ...
                If statoContratto.Text = "8" Or statoContratto.Text = "4" Then 'se rientro invia RA + CKIN 07.06.2022 salvo inserito status=4 x test
                    sm.sendmailMulipleFile(mail_mittente, "Sicily Rent Car - " & stazioneOut, mail_destinatario, oggmail, corpoMessaggio, True, fileallegato)
                Else
                    sm.sendmail(mail_mittente, "Sicily Rent Car - " & stazioneOut, mail_destinatario, oggmail, corpoMessaggio, True, fileallegato)
                End If
                ...
                If mail_destinatario2 <> "" Then
                    ...
                    If statoContratto.Text = "8" Then 'se rientro invia RA + CKIN 07.06.2022 salvo - aggiornato 14.06.2022 
                        sm.sendmailMulipleFile(mail_mittente, "Sicily Rent Car - " & stazioneOut, mail_destinatario2, oggmail2, corpoMessaggio2, True, fileallegato)
                    Else
                        sm.sendmail(mail_mittente, "Sicily Rent Car", mail_destinatario2, oggmail2, corpoMessaggio2, True, fileallegato)
                    End If
    ...
    Protected Function GetTestoMailContratto(lang As String, tipo As String) As String
        ...
        If lang = "ENG" Then
            ...
            If tipo = "AL" Then
                ...
                ris += "If there is no charge at the end of the rental contract, we remind you that if the security deposit was issued by pre-authorization on the card, the cancellation request will be made within 5 working days from the date of the end of the contract. In this case, there will be no refund and the cancelled amount will be available in the card plafond within a maximum of 21 days from the date of the original transaction.<br/><br/>"

                ris += "If the security deposit has been issued through debit card, the request for chargeback will be made within 5 working days from the date of end of contract. In this case, the time required to re-credit the sum depends on the bank circuit.<br/><br/>"
            ...
            Else
                ...
                ris += "All Sicily Rent Car rentals include free 24-hour road assistance. In case of road accident, breakdown, theft And robbery, fire, blows And damage to tires please contact the Operation Centre on the number provided in the vehicle's dashboard documents.<br/><br/>"
            ...
            ris += "Sicily Rent Car<br/><br/>"

            ris += "<a href='https://www.sicilyrentcar.it'><img src='http://ares.sicilyrentcar.it/img/SRC_logo.jpg'></a><br/>"
        ...
        Else
            ...
            If tipo = "AL" Then
                ...
                ris += "Qualora non fosse previsto alcun addebito, Le ricordiamo che, se il deposito cauzionale è stato rilasciato tramite pre-autorizzazione su carta, la richiesta di storno della stessa avverrà entro 5 giorni lavorativi dalla data di chiusura del contratto. In questo caso non è previsto alcun riaccredito, l’importo stornato tornerà disponibile nel plafond della carta entro un massimo di 21 giorni dalla data della transazione originaria.<br/><br/>"

                ris += "Se il deposito cauzionale è stato rilasciato tramite acquisto con bancomat, la richiesta di storno della transazione avverrà entro 5 giorni lavorativi dalla data di chiusura del contratto. In questo caso i tempi di riaccredito della somma dipendono dal circuito bancario di appartenenza.<br/><br/>"
            ...
            Else
                ...
                ris += "Tutti i noleggi Sicily Rent Car includono l'assistenza stradale gratuita h24. In caso di incidente stradale, guasto, furto e rapina, incendio, forature e danni agli pneumatici contattare la Centrale Operativa al numero verde disponibile tra i documenti presenti nel cruscotto del veicolo.<br/><br/>"
