...
Partial Class prenotazioniTony
    ...
    Protected Function SetDepositoCauzionale(ByVal iddoc As String, ByVal idgruppo As String, ByVal numcalcolo As String, ByVal refreshdatabind As Boolean) As String
        ...
        If almeno_un_gruppo_selezionato Then
            If (dropTariffeGeneriche.SelectedValue <> "0" And dropTariffeParticolari.SelectedValue = "0") Or (dropTariffeGeneriche.SelectedValue = "0" And dropTariffeParticolari.SelectedValue <> "0") Then
                ...
                If (min_giorni_nolo = "-1" And max_giorni_nolo = "-1") Or (min_giorni_nolo = "-1" And CInt(numero_giorni) <= CInt(max_giorni_nolo) And max_giorni_nolo <> "-1") Or (CInt(min_giorni_nolo) <= CInt(numero_giorni) And max_giorni_nolo = "-1" And min_giorni_nolo <> "-1") Or (CInt(min_giorni_nolo) <= CInt(numero_giorni) And CInt(max_giorni_nolo) >= CInt(numero_giorni) And min_giorni_nolo <> "-1" And max_giorni_nolo <> "-1") Then
                    ...
                    calcolaTariffe(id_tariffe_righe, imposta_prepagato)
                    listPrenotazioniCosti.DataBind()
    ...
    Protected Sub calcolaTariffe(ByVal id_tariffe_righe As String, ByVal imposta_prepagato As Boolean)
            ...
            For i = 0 To listGruppi.Items.Count - 1
                ...
                If sel_gruppo.Checked Then
                    ...
                    If imposta_prepagato OrElse ((Not txtGiorniPrepagati.Visible) AndAlso ((tariffaVendibile) OrElse (tariffa_broker.Text = "1" And CInt(txtNumeroGiorniTO.Text) > CInt(txtNumeroGiorni.Text)))) Then
                        ...
                        funzioni.calcolaTariffa_x_gruppo(dropStazionePickUp.SelectedValue, txtDaData.Text, CInt(ore1.Text), CInt(minuti1.Text), dropStazioneDropOff.SelectedValue, id_tariffe_righe, id_gruppo.Text, "", numero_giorni, giorni_prepagati, prepagata, 0, CDbl(txtSconto.Text), dropTipoSconto.SelectedValue, sconto_web_prepagato, 0, txtEtaPrimo.Text, txtEtaSecondo.Text, "", "", idPrenotazione.Text, "", numCalcolo.Text, Request.Cookies("SicilyRentCar")("idUtente"), id_ditta.Text, dropFonteCommissionabile.SelectedValue, txtPercentualeCommissionabile.Text, dropTipoCommissione.SelectedValue, False, lblGGcommissioniOriginali.Text)
                    Else
                        ...
                        End If
                        'Response.Write(giorni_prepagati)
                        funzioni.calcolaTariffa_x_gruppo(dropStazionePickUp.SelectedValue, txtDaData.Text, CInt(ore1.Text), CInt(minuti1.Text), dropStazioneDropOff.SelectedValue, id_tariffe_righe, id_gruppo.Text, "", numero_giorni, giorni_prepagati, prepagata, giorni_Extra_rack, CDbl(txtSconto.Text), dropTipoSconto.SelectedValue, 0, 0, txtEtaPrimo.Text, txtEtaSecondo.Text, "", "", idPrenotazione.Text, "", numCalcolo.Text, Request.Cookies("SicilyRentCar")("idUtente"), id_ditta.Text, dropFonteCommissionabile.SelectedValue, txtPercentualeCommissionabile.Text, dropTipoCommissione.SelectedValue, False, lblGGcommissioniOriginali.Text)
                    End If
                End If
            Next
        Else
            ...
            If imposta_prepagato OrElse ((Not txtGiorniPrepagati.Visible) AndAlso ((tariffaVendibile) OrElse (tariffa_broker.Text = "1" And CInt(txtNumeroGiorniTO.Text) > CInt(txtNumeroGiorni.Text)))) Then
                ...
                funzioni.calcolaTariffa_x_gruppo(dropStazionePickUp.SelectedValue, txtDaData.Text, CInt(ore1.Text), CInt(minuti1.Text), dropStazioneDropOff.SelectedValue, id_tariffe_righe, gruppoDaCalcolare.SelectedValue, "", numero_giorni, giorni_prepagati, prepagata, 0, CDbl(txtSconto.Text), dropTipoSconto.SelectedValue, sconto_web_prepagato, 0, txtEtaPrimo.Text, txtEtaSecondo.Text, "", "", idPrenotazione.Text, "", numCalcolo.Text, Request.Cookies("SicilyRentCar")("idUtente"), id_ditta.Text, dropFonteCommissionabile.SelectedValue, txtPercentualeCommissionabile.Text, dropTipoCommissione.SelectedValue, False, lblGGcommissioniOriginali.Text)
            Else
                Dim giorni_Extra_rack As Integer
                If txtGiorniPrepagati.Visible Then
                    giorni_Extra_rack = (numero_giorni - CInt(txtGiorniPrepagati.Text))
                ...
                If giorni_Extra_rack < 0 Then
                    giorni_Extra_rack = 0
                End If
                funzioni.calcolaTariffa_x_gruppo(dropStazionePickUp.SelectedValue, txtDaData.Text, CInt(ore1.Text), CInt(minuti1.Text), dropStazioneDropOff.SelectedValue, id_tariffe_righe, gruppoDaCalcolare.SelectedValue, "", numero_giorni, giorni_prepagati, prepagata, giorni_Extra_rack, CDbl(txtSconto.Text), dropTipoSconto.SelectedValue, 0, 0, txtEtaPrimo.Text, txtEtaSecondo.Text, "", "", idPrenotazione.Text, "", numCalcolo.Text, Request.Cookies("SicilyRentCar")("idUtente"), id_ditta.Text, dropFonteCommissionabile.SelectedValue, txtPercentualeCommissionabile.Text, dropTipoCommissione.SelectedValue, False, lblGGcommissioniOriginali.Text)
            End If
        End If
    ...
    Protected Sub AggiornaPrenotazione(ByVal idgruppo)
    ...
    End Sub
    Public Sub VerificaCk(ByVal tResponse As String, ByVal tResponseOld As String, ByRef id_gruppoSceltoT As Label, ByVal lst As DataList)
    ...
    Protected Sub richiama_prenotazione(ByVal num_pren As String)
        ...
        Try
            ...
            Dim Dbc As New Data.SqlClient.SqlConnection(Web.Configuration.WebConfigurationManager.ConnectionStrings("SicilyConnectionString").ConnectionString)
            Dbc.Open()
            Dim Cmd As New Data.SqlClient.SqlCommand("SELECT ISNULL(prepagata,'False') As prepagata, ISNULL(pren_broker_no_tariffa,'False') As pren_broker_no_tariffa, * FROM prenotazioni WITH(NOLOCK) WHERE NUMPREN='" & num_pren & "' AND attiva='1'", Dbc)
    ...
    Protected Sub GetList_anno(ByVal id)
    ...
    Protected Sub btnRicalcolaPrepagato_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRicalcolaPrepagato.Click
    ...
    Private Function getCodGruppoById(ByVal IdGruppo As String, Optional ByVal Attivo As Boolean = False) As String
    ...
    Private Sub setTipoCodiceFattura(ByVal from_fatture As TipoCodiceFattura)
    ...
    Protected Sub btnApplicaCodiceSconto_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnApplicaCodiceSconto.Click
    ...
    Protected Sub btnVisualizzaCC_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnVisualizzaCC.Click
        txtPOS_Carta.Focus()
    ...
    Protected Sub btnModificaDataPagamento_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnModificaDataPagamento.Click
    ...
    Protected Sub btnEliminaPagamento_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEliminaPagamento.Click
        Dim conn As New System.Data.SqlClient.SqlConnection(Web.Configuration.WebConfigurationManager.ConnectionStrings("SicilyConnectionString").ConnectionString)
        conn.Open()
    ...
    Protected Sub btnAzzeraPagamento_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAzzeraPagamento.Click
        Dim conn As New System.Data.SqlClient.SqlConnection(Web.Configuration.WebConfigurationManager.ConnectionStrings("SicilyConnectionString").ConnectionString)
        conn.Open()
    ...
    Protected Sub btnIncassoWeb_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnIncassoWeb.Click
        ...
        Dim strSql As String = "UPDATE PAGAMENTI_EXTRA SET id_modpag=NULL, id_tippag='1011098650', id_pos_funzioni_ares='4', cassa='0', intestatario='', scadenza='', " & _
            "nr_aut='0000023', tipsegno='1', note=NULL, id_operatore_ares=NULL, utecre='web', nr_batch='000018', contabilizzato='0',  TRANSATION_TYPE='MAG', " & _
    ...
    Protected Sub btnIncassoBroker_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnIncassoBroker.Click
        Dim Dbc As New Data.SqlClient.SqlConnection(Web.Configuration.WebConfigurationManager.ConnectionStrings("SicilyConnectionString").ConnectionString)
        Dbc.Open()
    ...
    Protected Sub upload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles upload.Click
        ...
        Else
            ...
            If UploadAllegati.HasFile Then
                ...
                Dim sqlall As String = "INSERT INTO contratti_prenotazioni_allegati (nome_file, cartella,num_pren, id_cnt_pren_allegati_tipo, nome_file_operatore) " &
                                                         " VALUES ('" & nome_file & "','" & my_path & "','" & txtNumPrenotazione.Text & "'," & dropNuovoAllegato.SelectedValue & ",'" & nome_file_operatore & "')"
                ...
                While File.Exists(filePath & nome_file)
                    ...
                    sqlall = "INSERT INTO contratti_prenotazioni_allegati (nome_file, cartella, num_pren, id_cnt_pren_allegati_tipo, nome_file_operatore) " &
                                                         " VALUES ('" & nome_file & "','" & my_path & "','" & txtNumPrenotazione.Text & "'," & dropNuovoAllegato.SelectedValue & ",'" & nome_file_operatore & "')"
    ...
    Protected Sub dataListAllegati_ItemCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ListViewCommandEventArgs) Handles dataListAllegati.ItemCommand
        If e.CommandName = "elimina" Then
            ...
            Try
                ...
                sqlAllegati.SelectCommand = "SELECT id_allegato, nome_file, cartella, (cartella + nome_file) as my_path, descrizione FROM contratti_prenotazioni_allegati WITH(NOLOCK) " & _
                                        "INNER JOIN contratti_prenotazioni_allegati_tipo WITH(NOLOCK) ON contratti_prenotazioni_allegati.id_cnt_pren_allegati_tipo=contratti_prenotazioni_allegati_tipo.id_cnt_pren_allegati_tipo WHERE num_pren='" & lblNumPrenotazione.Text & "'"
                dataListAllegati.DataBind()
    ...
    Private Sub btnAggiungiExtra_Command(ByVal sender As Object, ByVal e As CommandEventArgs) Handles btnAggiungiExtra.Command
