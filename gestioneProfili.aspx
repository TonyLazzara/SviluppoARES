<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageNoMenuX.master" AutoEventWireup="false" CodeFile="gestioneProfili.aspx.vb" Inherits="gestioneProfili" %>
...
<table border="0" cellpadding="1" cellspacing="1" width="1024px" >
 <tr>
   <td class="style1">
      <asp:Label ID="lblProfilo" runat="server" Text="Profilo:" CssClass="testo_bold"></asp:Label>
     &nbsp;
   </td>
   <td class="style2">
   ...
   <td>
       <asp:Button ID="btnNuovoProfilo" runat="server" Text="Nuovo Profilo" />
     </td>
 </tr>
 <tr runat="server" id="riga_intestazione" visible="false">
   <td class="style1">
      <asp:Label ID="lblNomeProfilo" runat="server" Text="Nome Profilo:" CssClass="testo_bold" Visible="false"></asp:Label>
     </td>
   <td class="style2">
       <asp:TextBox ID="txtNomeProfilo" runat="server" MaxLength="30" Width="300px" ></asp:TextBox>
     </td>
    <td>
    </td> 
 </tr>
</table> 
<table runat="server" id="lista_funzionalita" visible="false" border="0" cellpadding="1" cellspacing="1" width="1024px" >
 <tr>
 ...
 <tr>
   <td width="50%"  style="color: #FFFFFF" bgcolor="#369061">  
       <b>Gestione POS - Accesso alla funzionalità:<asp:CheckBox ID="checkGestionePOS" runat="server" /></b>
   </td>
   <td width="50%"  style="color: #FFFFFF" bgcolor="#369061">
 ...
 <tr>
   <td width="50%" align="center" colspan="2" style="width: 100%">
    ...
    <asp:SqlDataSource ID="sqlPermessiParcoVeicoli" runat="server" 
        ConnectionString="<%$ ConnectionStrings:SicilyConnectionString %>" 
        SelectCommand="SELECT permessi_profili_funzionalita.id, funzionalita.descrizione As funzionalita,funzionalita.id As id_funzionalita, id_livello_accesso FROM permessi_profili_funzionalita WITH(NOLOCK) INNER JOIN funzionalita WITH(NOLOCK) ON permessi_profili_funzionalita.id_funzionalita=funzionalita.id WHERE (id_permessi_profili = @id_permessi_profili) AND (funzionalita.id_macro_funzionalita='1') AND (funzionalita.id <> '1') ORDER BY funzionalita.descrizione">
        <SelectParameters>
            <asp:ControlParameter ControlID="id_profilo" Name="id_permessi_profili" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="sqlPermessiTabelle" runat="server" 
        ConnectionString="<%$ ConnectionStrings:SicilyConnectionString %>" 
        SelectCommand="SELECT permessi_profili_funzionalita.id, funzionalita.descrizione As funzionalita,funzionalita.id As id_funzionalita, id_livello_accesso FROM permessi_profili_funzionalita WITH(NOLOCK) INNER JOIN funzionalita WITH(NOLOCK) ON permessi_profili_funzionalita.id_funzionalita=funzionalita.id WHERE (id_permessi_profili = @id_permessi_profili) AND (funzionalita.id_macro_funzionalita='2') AND (funzionalita.id <> '9') ORDER BY funzionalita.descrizione">
        <SelectParameters>
            <asp:ControlParameter ControlID="id_profilo" Name="id_permessi_profili" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="sqlPermessiOrdinativoLavori" runat="server" 
        ConnectionString="<%$ ConnectionStrings:SicilyConnectionString %>" 
        SelectCommand="SELECT permessi_profili_funzionalita.id, funzionalita.descrizione As funzionalita,funzionalita.id As id_funzionalita, id_livello_accesso FROM permessi_profili_funzionalita WITH(NOLOCK) INNER JOIN funzionalita WITH(NOLOCK) ON permessi_profili_funzionalita.id_funzionalita=funzionalita.id WHERE (id_permessi_profili = @id_permessi_profili) AND (funzionalita.id_macro_funzionalita='5') AND (funzionalita.id <> '30') ORDER BY funzionalita.descrizione">
        <SelectParameters>
            <asp:ControlParameter ControlID="id_profilo" Name="id_permessi_profili" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="sqlPermessiFunzioniVeicoli" runat="server" 
        ...
        SelectCommand="SELECT permessi_profili_funzionalita.id, funzionalita.descrizione As funzionalita,funzionalita.id As id_funzionalita, id_livello_accesso FROM permessi_profili_funzionalita WITH(NOLOCK) INNER JOIN funzionalita WITH(NOLOCK) ON permessi_profili_funzionalita.id_funzionalita=funzionalita.id WHERE (id_permessi_profili = @id_permessi_profili) AND (funzionalita.id_macro_funzionalita='6') AND (funzionalita.id <> '33') ORDER BY funzionalita.descrizione">
        <SelectParameters>
            <asp:ControlParameter ControlID="id_profilo" Name="id_permessi_profili" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="sqlPermessiGestioneListini" runat="server" 
        ...
        SelectCommand="SELECT permessi_profili_funzionalita.id, funzionalita.descrizione As funzionalita,funzionalita.id As id_funzionalita, id_livello_accesso FROM permessi_profili_funzionalita WITH(NOLOCK) INNER JOIN funzionalita WITH(NOLOCK) ON permessi_profili_funzionalita.id_funzionalita=funzionalita.id WHERE (id_permessi_profili = @id_permessi_profili) AND (funzionalita.id_macro_funzionalita='8') AND (funzionalita.id <> '44') ORDER BY funzionalita.descrizione">
        <SelectParameters>
            <asp:ControlParameter ControlID="id_profilo" Name="id_permessi_profili" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="sqlPermessiTabelleListini" runat="server" 
        ...
        SelectCommand="SELECT permessi_profili_funzionalita.id, funzionalita.descrizione As funzionalita,funzionalita.id As id_funzionalita, id_livello_accesso FROM permessi_profili_funzionalita WITH(NOLOCK) INNER JOIN funzionalita WITH(NOLOCK) ON permessi_profili_funzionalita.id_funzionalita=funzionalita.id WHERE (id_permessi_profili = @id_permessi_profili) AND (funzionalita.id_macro_funzionalita='7') AND (funzionalita.id <> '39') ORDER BY funzionalita.descrizione">
        <SelectParameters>
            <asp:ControlParameter ControlID="id_profilo" Name="id_permessi_profili" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
     ...
     <asp:SqlDataSource ID="sqlPermessiStazioni" runat="server" 
        ...
        SelectCommand="SELECT permessi_profili_funzionalita.id, funzionalita.descrizione As funzionalita,funzionalita.id As id_funzionalita, id_livello_accesso FROM permessi_profili_funzionalita WITH(NOLOCK) INNER JOIN funzionalita WITH(NOLOCK) ON permessi_profili_funzionalita.id_funzionalita=funzionalita.id WHERE (id_permessi_profili = @id_permessi_profili) AND (funzionalita.id_macro_funzionalita='9') AND (funzionalita.id <> '51') ORDER BY funzionalita.descrizione">
        <SelectParameters>
            <asp:ControlParameter ControlID="id_profilo" Name="id_permessi_profili" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sqlPermessiGestioneVal" runat="server" 
        ...
        SelectCommand="SELECT permessi_profili_funzionalita.id, funzionalita.descrizione As funzionalita,funzionalita.id As id_funzionalita, id_livello_accesso FROM permessi_profili_funzionalita WITH(NOLOCK) INNER JOIN funzionalita WITH(NOLOCK) ON permessi_profili_funzionalita.id_funzionalita=funzionalita.id WHERE (id_permessi_profili = @id_permessi_profili) AND (funzionalita.id_macro_funzionalita='10') AND (funzionalita.id <> '58') ORDER BY funzionalita.descrizione">
        <SelectParameters>
            <asp:ControlParameter ControlID="id_profilo" Name="id_permessi_profili" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sqlPermessiGestinePos" runat="server" 
        ...
        SelectCommand="SELECT permessi_profili_funzionalita.id, funzionalita.descrizione As funzionalita,funzionalita.id As id_funzionalita, id_livello_accesso FROM permessi_profili_funzionalita WITH(NOLOCK) INNER JOIN funzionalita WITH(NOLOCK) ON permessi_profili_funzionalita.id_funzionalita=funzionalita.id WHERE (id_permessi_profili = @id_permessi_profili) AND (funzionalita.id_macro_funzionalita='11') AND (funzionalita.id <> '61') ORDER BY funzionalita.descrizione">
        <SelectParameters>
            <asp:ControlParameter ControlID="id_profilo" Name="id_permessi_profili" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sqlPreventiviPrenotazioniContratti" runat="server" 
        ...
        SelectCommand="SELECT permessi_profili_funzionalita.id, funzionalita.descrizione As funzionalita,funzionalita.id As id_funzionalita, id_livello_accesso FROM permessi_profili_funzionalita WITH(NOLOCK) INNER JOIN funzionalita WITH(NOLOCK) ON permessi_profili_funzionalita.id_funzionalita=funzionalita.id WHERE (id_permessi_profili = @id_permessi_profili) AND (funzionalita.id_macro_funzionalita='12') AND (funzionalita.id <> '71') ORDER BY funzionalita.descrizione">
        <SelectParameters>
            <asp:ControlParameter ControlID="id_profilo" Name="id_permessi_profili" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sqlGestioneMulte" runat="server" 
        ...
        SelectCommand="SELECT permessi_profili_funzionalita.id, funzionalita.descrizione As funzionalita,funzionalita.id As id_funzionalita, id_livello_accesso FROM permessi_profili_funzionalita WITH(NOLOCK) INNER JOIN funzionalita WITH(NOLOCK) ON permessi_profili_funzionalita.id_funzionalita=funzionalita.id WHERE (id_permessi_profili = @id_permessi_profili) AND (funzionalita.id_macro_funzionalita='13') AND (funzionalita.id <> '89') ORDER BY funzionalita.descrizione">
        <SelectParameters>
            <asp:ControlParameter ControlID="id_profilo" Name="id_permessi_profili" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sqlGestioneDanni" runat="server" 
        ...
        SelectCommand="SELECT permessi_profili_funzionalita.id, funzionalita.descrizione As funzionalita,funzionalita.id As id_funzionalita, id_livello_accesso FROM permessi_profili_funzionalita WITH(NOLOCK) INNER JOIN funzionalita WITH(NOLOCK) ON permessi_profili_funzionalita.id_funzionalita=funzionalita.id WHERE (id_permessi_profili = @id_permessi_profili) AND (funzionalita.id_macro_funzionalita='14') AND (funzionalita.id <> '103') ORDER BY funzionalita.descrizione">
        <SelectParameters>
           <asp:ControlParameter ControlID="id_profilo" Name="id_permessi_profili" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sqlAnagrafica" runat="server" 
        ...
        SelectCommand="SELECT permessi_profili_funzionalita.id, funzionalita.descrizione As funzionalita,funzionalita.id As id_funzionalita, id_livello_accesso FROM permessi_profili_funzionalita WITH(NOLOCK) INNER JOIN funzionalita WITH(NOLOCK) ON permessi_profili_funzionalita.id_funzionalita=funzionalita.id WHERE (id_permessi_profili = @id_permessi_profili) AND (funzionalita.id_macro_funzionalita='4') AND (funzionalita.id <> '119') ORDER BY funzionalita.descrizione">
        <SelectParameters>
            <asp:ControlParameter ControlID="id_profilo" Name="id_permessi_profili" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
