...
Partial Class sql1
    ...
    Public Class elencoveicoli
        Public Property idgruppo() As String
            Get
                Return m_idgruppo
            End Get
            Set
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'txt_data_uscita.Text = "07/07/2021"
        'txt_data_rientro.Text = "14/07/2021"

        'txt_ora_uscita.Text = "22:00"
        'txt_ora_rientro.Text = "23:00"

        'ddl_stazione_uscita.SelectedValue = "4"             'CATANIA APT
        'ddl_stazione_rientro.SelectedValue = "4"


        lbl_oow.Text = Date.Now.ToString
    ...
    Protected Sub btn_go_Click(sender As Object, e As EventArgs)
        ...
        Dim data_uscita As String = txt_data_uscita.Text
        Dim ora_uscita As String = txt_ora_uscita.Text
        Dim data_rientro As String = txt_data_rientro.Text
        Dim ora_rientro As String = txt_ora_rientro.Text
        Dim ngiorni As String = "7"
        Dim stazione As String = ddl_stazione_uscita.SelectedValue
        Dim stazioneOff As String = ddl_stazione_rientro.SelectedValue
        Dim IdTipoCliente As Integer = 0
        Dim codpromo As String = ""
        Dim eta As String = "40"
        Dim lingua As String = "ITA"
        Try
            ...
            'Label1.Text = get_tariffa_x_righe(data_uscita, data_rientro, ngiorni, stazione, stazioneOff, IdTipoCliente, codpromo)

            'Label2.Text = get_tariffa_x_righe_prepagato(data_uscita, data_rientro, ngiorni, stazione, stazioneOff, IdTipoCliente, codpromo)

            txt_result.Text = getElencoVeicoli(stazione, data_uscita, ora_uscita, stazioneOff, data_rientro, ora_rientro, eta, IdTipoCliente, lingua, codpromo)

            Dim edate As String = Date.Now.Hour & "h : " & Date.Now.Minute & "m : " & Date.Now.Second & "s : " & Date.Now.Millisecond & "ms"

            Label2.Text = "Start: " & edate.ToString

            If InStr(1, txt_result.Text, "errore", 1) > 0 Then

                lbl_error.Text = "Errore Tariffe"
                lbl_error.ForeColor = Drawing.Color.Red

            Else
                lbl_error.Text = "Tariffe OK"
                lbl_error.ForeColor = Drawing.Color.Green
            End If

            ''recupera valori tariffe
            'Dim jsonText As String = txt_result.Text
            'Dim jss As New JavaScriptSerializer()
            ''Dim dict = jss.Deserialize(Of List(Of elencoveicoli))(jsonText)


            'Dim j As Object = New JavaScriptSerializer().Deserialize(Of Object)(jsonText)
            ''Dim a = j("gruppo")                   ' returns empty Object() array
            'Dim b As String = j("id_gruppo")(0)            ' returns Dictionary(Of String, Object)
    ...
    Function get_tariffa_x_righe(ByVal data_uscita As String, ByVal data_rientro As String, ByVal giorni_nolo As String, ByVal stazione As String, ByVal stazioneOff As String, ByVal IdTipCliente As Integer, ByVal cod_promo As String) As String
        ...
        Try
            If cod_promo & "" <> "" Then
                ...
                sql = "SELECT top(1) tariffe_righe.id FROM tariffe WITH(NOLOCK) INNER JOIN tariffe_righe WITH(NOLOCK) ON tariffe.id=tariffe_righe.id_tariffa WHERE  tariffe.attiva='1' AND GetDate() BETWEEN tariffe_righe.vendibilita_da AND tariffe_righe.vendibilita_a  AND convert(datetime,'" & pickup_da & "',102) BETWEEN tariffe_righe.pickup_da AND tariffe_righe.pickup_a AND  tariffe.codicepromozionale='" & cod_promo & "' ORDER BY codice"
            ...
            Else
                ...
                sql = "(SELECT top(1) tariffe_righe.id FROM tariffe WITH(NOLOCK) " &
    ...
    Sub salvaWarning(ByVal id_preventivo As String, ByVal id_ribaltamento As String, ByVal id_prenotazione As String, ByVal id_contratto As String, ByVal num_calcolo As String, ByVal numero_warning As String, ByVal id_utente As String, ByVal stringa As String)
        ...
        Dbc = Nothing
    End Sub
    'Fine procedure richiamate da GetElencoVeicoli
    ...
    Protected Sub btnrefresh_Click(sender As Object, e As EventArgs)
        Response.Redirect("sql_test_tariffe.aspx")
    End Sub
End Class
