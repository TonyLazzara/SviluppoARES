<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageNoMenuX.master" AutoEventWireup="true" CodeFile="contratti.aspx.vb" 
    Inherits="contratti" MaintainScrollPositionOnPostback="true" %>
    ...
    <script type="text/javascript">
        ...
        function checkDate(sender, args) {
            if (sender._selectedDate < new Date()) {
                alert("Non è possibile selezionare una data antecedente la data odirna!");
        ...
        function preventMultipleSubmissions(ele, e, nrco) {
            ...
            //msg di annulla per CRV aggiunto 12.07.2022 salvo
            if (nrco == 7) {
                if (confirm('Attenzione: sei sicuro di voler eliminare il documento?') == false) {
                    return false;
                }
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <tr>
        <td align="center" style="color: #FFFFFF;background-color:#444;" >
            ...
            <asp:Label ID="lblRDS" runat="server" Text=""  CssClass="testo_titolo" ForeColor="White" BackColor="Red" Visible="false"></asp:Label>
             ...
             <asp:Label ID="lbl_data_creazione" runat="server"  CssClass="testo_titolo" Visible="false"></asp:Label> <%--aggiunto 10.01.2023 salvo x verifica creazione --%>
            <asp:Label ID="lbl_data_out_originale" runat="server"  CssClass="testo_titolo" Visible="false"></asp:Label> <%--aggiunto 11.01.2023 salvo x verifica data out --%>
  ...
  <td valign="top" class="style9">
      ...
      <%--<a onclick="GetCalendar(document.getElementById('<%=txtAData.ClientID%>'),'e')"> </a>--%>
        ...
        <ajaxtoolkit:CalendarExtender  runat="server" 
            ...
            OnClientDateSelectionChanged="checkDate" ></ajaxtoolkit:CalendarExtender> --%>         
  ...
  <td valign="top">
   ...
   <tr>
      <td valign="top" class="style4" colspan="10" align="center">
        ...
        <asp:Button ID="btnAnnullaDocumento" runat="server" Text="Annulla ed esci" OnClientClick="return preventMultipleSubmissions(this, event, 1);"/>
        
                <asp:Button ID="btnCRV" runat="server" Text="CRV" Visible="false" CssClass="btn"  
                     OnClientClick="return preventMultipleSubmissions(this, event, 5);"               
               /><%--OnClientClick="javascript: return(window.confirm ('Attenzione: sei sicuro di voler effettuare una sostituzione del veicolo attuale?.'));"--%>
                <asp:Button ID="btnAnnullaCRV" runat="server" Text="Annulla CRV" Visible="false" />
                    <%--OnClientClick="javascript: return(window.confirm ('Attenzione: sei sicuro di voler annullare il CRV attuale?.'));" --%> 

        <asp:Button ID="btnRicalcolaModificaContratto" runat="server" 
              Text="Modifica/Estensione" Visible="false" ValidationGroup="cerca"  OnClientClick="return preventMultipleSubmissions(this, event, 1);"
       ...
       <asp:Button ID="bt_Gestione_RDS" runat="server" Text="Gestione RDS" 
        ...
        <asp:Button ID="bt_Check_Out" runat="server" Text="Check Out" Visible="false" OnClientClick="return preventMultipleSubmissions(this, event, 1);"  />
        ...
        <asp:Button ID="btnPagamentoModEstensione" runat="server" Text="Pagamento" Visible="False" style="text-align: left"  OnClientClick="return preventMultipleSubmissions(this, event, 1);" />
   ...
   <tr runat="server" id="riga_fatturazione" visible="false" >
    ...
    TargetControlID="txtDataFattura" ID="MaskedEditExtender7">
          ...
          <asp:Button ID="btnStampaFatturaCliente" runat="server" Text="Stampa Fattura Cliente" Visible="false" OnClientClick="return preventMultipleSubmissions(this, event, 1);" />
          <asp:Button ID="btnStampaFatturaBroker" runat="server" Text="Stampa Fattura Broker" Visible="false" OnClientClick="return preventMultipleSubmissions(this, event, 1);" />
          <asp:Button ID="btnStampaFatturaPrepagato" runat="server" Text="Stampa Fattura Prepagato" Visible="false" OnClientClick="return preventMultipleSubmissions(this, event, 1);" />
   ...
   <tr>
      <td valign="top" class="style4" colspan="10" align="center">
          <asp:Button ID="btnQuickCheckIn" runat="server" Text="Quick Check In" Width="70%" visible="false" 
              OnClientClick="return preventMultipleSubmissions(this, event, 2);" />
              <%--OnClientClick="javascript: return(window.confirm ('Attenzione: sei sicuro di voler effettuare il Quick Check In? Il contratto non sarà più modificabile.'));"--%> 
          <asp:Button ID="btnAnnullaQuickCheckIn" runat="server" Text="Annulla Quick Check In" 
              Width="30%" visible="false" 
               OnClientClick="return preventMultipleSubmissions(this, event, 3);" />
                  ...
                  <asp:Button ID="btnRegistraPieno" runat="server" Text="Registra" ValidationGroup="pieno_carburante" />
                   ...
                   <!-- Data Movimento -->
                     <asp:RequiredFieldValidator ID="RFData" runat="server" 
                               ...
                               Font-Size="0pt" SetFocusOnError="true" ValidationGroup="pieno_carburante"> </asp:RequiredFieldValidator>
    ...
    CssHeader="toolheader"  CssBody="toolbody"   />
      ...
      <tr>
          ...
          &nbsp;&nbsp;
                ...
                <asp:Label ID="lblOLDDifferenzaDaPrenotazione" runat="server" ForeColor="Blue" 
                    CssClass="testo_bold" Visible="False" Font-Size="16px"></asp:Label>
                      ...
                      <tr runat="server" id="riga_elementi">
                         ...
                         <td>
                            ...
                            <asp:Label ID="costo_scontato" runat="server" Text='<%# FormatNumber(Eval("valore_costo") - Eval("sconto"),2) %>' CssClass="testo" />&nbsp;
                             <asp:TextBox ID="txtValore" runat="server" Width="50px" ></asp:TextBox>&nbsp;
                            <asp:Button ID="btnSalva" runat="server" CommandName = "Salva_valoreExtra" Text="salva plus"  />
                            <asp:TextBox ID="txtvaloreTariffa" runat="server" Width="50px" visible="false"></asp:TextBox>&nbsp;
                            <asp:Button ID="btnSalvaValoreTariffa" runat="server" CommandName = "Salva_valoreTariffa" Text="salva" visible="false" />
                         </td>
       ...
       <table style="border-top:0px;" border="0" cellspacing="1" cellpadding="1" width="100%">
         ...
         <tr>
           ...
           <td class="style36">
             ...
             <asp:Label ID="Label70" runat="server" Text="Codice Auth." CssClass="testo_bold" />
      
             </td>
           <%--<td class="style36">
      
             <asp:Label ID="Label133" runat="server" Text="PAN" CssClass="testo_bold" />
         ...
         <tr>
           ...
           <td class="style36">
                ...
                <%-- <asp:TextBox ID="txtPOS_ScadenzaPreaut" runat="server" Width="140px" 
                  ...
                  <asp:TextBox ID="txtPOS_CodiceAuth" runat="server" Width="140px" 
                     ReadOnly="true"></asp:TextBox>
             </td>
            <%--<td class="style36">
                     
                  <asp:TextBox ID="txtPAN" runat="server" Width="140px" 
                     ReadOnly="true"></asp:TextBox>
             </td>--%>
           <td class="style37">
         ...
         <tr>
           <td colspan="8" align="center">
              ...
              <!-- Tony 11/10/2022 -->
              <asp:Button ID="btnSwitchDepAcq" runat="server" Text="Switch (Deposito >> Acquisto)" OnClientClick="javascript: return(window.confirm ('Attenzione: sei sicuro di voler cambiare modalità da Deposito ad Acquisto ? Operazione non reversibile.'));"  />
              <!-- FINE TONY --> 
        ...
        <asp:ListView ID="ListViewAllegati" runat="server" DataSourceID="sqlAllegati" DataKeyNames="Id_allegato" >
            <ItemTemplate>
                <tr style="background-color:#FFFFFF; color: #000000; ">                    
                    <td>
                        <asp:Label ID="lblIdAllegato" runat="server" Text='<%# Eval("Id_allegato") %>' Visible="False"></asp:Label>
                        <asp:Label ID="lblPercorsoFile" runat="server" Text='<%# Eval("my_path") %>' Visible="False"></asp:Label>
                        <asp:Label ID="lblTipo" runat="server" Text='<%# Eval("descrizione") %>'></asp:Label>
                    </td>
                    <td><asp:Label ID="lblNomeFile" runat="server" Text='<%# Eval("Nome_File") %>'></asp:Label></td>                   
                    <td style="text-align:center;"><asp:Label ID="lbl_data_caricamento" runat="server" Text='<%# Eval("data_operazione") %>'></asp:Label></td>
                    <td style="text-align:center;"><asp:Label ID="lblOperatore" runat="server" Text='<%# Eval("id_operatore") %>'></asp:Label></td>
                    ...
                    <td align="center"><asp:ImageButton ID="EliminaAllegato" OnClientClick="return preventMultipleSubmissions(this, event, 7);"  runat="server" ImageUrl="/images/elimina.png" style="width: 16px" CommandName="EliminaAllegato"/></td>
                        ...
                        <td id="Td1" runat="server">
                            <table ID="itemPlaceholderContainer" runat="server" border="1" style="background-color: #FFFFFF;border-collapse: collapse;border-color: #999999;border-style:none;border-width:0px;font-family: Verdana, Arial, Helvetica, sans-serif;" width="100%">
                                <tr id="Tr3" runat="server" style="color: #FFFFFF;background-color:#000000;" >
                                    ...
                                    <th id="Th2" runat="server" style="width:175px;">Tipo</th>
                                    <th id="Th3" runat="server">Nome File</th>
                                    <th id="Th4" runat="server" style="width:175px;">Data e Ora</th>
                                    <th id="Th23" runat="server">Operatore</th>
...
<div runat="server" id="DivFattureMulte" visible="false" 
    ...
    <asp:Label ID="contratto_num" runat="server" visible="true"></asp:Label>
    
    <asp:Label ID="numCalcolo" runat="server" visible="False"></asp:Label>
    <asp:Label ID="numCrv" runat="server" visible="false"></asp:Label>
    <asp:Label ID="idPrenotazione" runat="server" visible="true"></asp:Label>
  ...
  <asp:SqlDataSource ID="sqlTipoAllegati" runat="server" 
    ...
    <asp:SqlDataSource ID="sqlAllegati" runat="server" 
        ConnectionString="<%$ ConnectionStrings:SicilyConnectionString %>" 
        SelectCommand="SELECT id_allegato, nome_file, cartella, (cartella + nome_file) as my_path, descrizione, id_operatore FROM contratti_prenotazioni_allegati WITH(NOLOCK) 
