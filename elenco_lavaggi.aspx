<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageNoMenuX.master" AutoEventWireup="false" CodeFile="elenco_lavaggi.aspx.vb" Inherits="elenco_lavaggi" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="1024px" >
         <tr>
           <td colspan="8" align="left" style="color: #FFFFFF;background-color:#444;" class="style1">
               <asp:Label ID="Label2" runat="server" Text="Elenco Lavaggi" CssClass="testo_titolo"></asp:Label>
           </td>
         </tr>
    </table>
   <table cellpadding="0" cellspacing="2" width="1024px" style="border:4px solid #444" border="0">   
        <tr>
          ...
          <td align="left" class="style37">
              <asp:Label ID="TxtData" runat="server" Text="Data Lavaggio dal/Al" CssClass="testo_bold"></asp:Label>
           </td>  
          <td align="left" class="style37">
        ...
        <tr>
          ...
          <td align="left" class="style4">
              <a onclick="Calendar.show(document.getElementById('<%=TxtDataDal.ClientID%>'), '%d/%m/%Y', false)">
               <asp:TextBox ID="TxtDataDal" runat="server" Width="85px"></asp:TextBox>
                  </a>
              <%-- <asp:CalendarExtender ID="TxtDataDal_CalendarExtender" runat="server" Format="dd/MM/yyyy" 
               ...
               <asp:TextBox ID="TxtDataAl" runat="server" Width="85px"></asp:TextBox>
                   </a>
          ...
          <td align="left" class="style54">
               <asp:DropDownList ID="dropStatoVendita" runat="server" AppendDataBoundItems="True" 
                   ...
                   <asp:ListItem Selected="False" Value="0">Qualsiasi</asp:ListItem>
                    <asp:ListItem Selected="True" Value="1">Da lavare</asp:ListItem>                    
                   <asp:ListItem Selected="False" Value="2">A lavaggio</asp:ListItem>                                          
                   <asp:ListItem Selected="False" Value="3">Lavato</asp:ListItem>                                          
               </asp:DropDownList>
               ...
               <asp:Button ID="btnPulisciCampi" runat="server" 
                  Text="Azzera Campi" Visible="True" style="height: 26px" 
              ...
              <asp:ListView ID="listRifornimenti" runat="server" DataKeyNames="id" DataSourceID="SqlRifornimenti">
                   <ItemTemplate>
                      <tr style="background-color:#DCDCDC;color: #000000;">
                          ...
                          <td>
                              <asp:Label ID="MovimentiLabel" runat="server" Text='<%# Eval("disponibile_nolo") %>' />
                          </td>                                           
                          <td align="center">
                                  ...
                                  <table ID="itemPlaceholderContainer" runat="server" border="1" width="100%"  
                                      ...
                                      <tr id="Tr2" runat="server" style="color: #FFFFFF" bgcolor="#19191b">
                                          ...
                                          <th id="Th9" runat="server" align="left">
                                              <!--<asp:LinkButton ID="LinkButton9" runat="server" CommandName="order_by_CapacitaSerbatoio" CssClass="testo_titolo">Cap.Serb.</asp:LinkButton>-->
                                              <asp:Label ID="LblCapacitaSerbatoio" runat="server" Text="Cap.Serb." CssClass="testo_titolo"></asp:Label>
                                          </th>                                                                                                                            
                                          <th id="Th10" runat="server" align="left">
                                              <!--<asp:LinkButton ID="LinkButton10" runat="server" CommandName="order_by_Alimentazione" CssClass="testo_titolo">Alim.</asp:LinkButton>-->
                                          ...
                                          <th id="Th3" runat="server" align="left">
                                              <!--<asp:LinkButton ID="LinkButton3" runat="server" CommandName="order_by_KmOut" CssClass="testo_titolo">Km Out</asp:LinkButton>-->
                                          ...
                                          <th id="Th5" runat="server" align="left">
                                             <!--<asp:LinkButton ID="LinkButton4" runat="server" CommandName="order_by_KmIn" CssClass="testo_titolo">Km In</asp:LinkButton> -->
                                             <asp:Label ID="LblKmIn" runat="server" Text="Km In" CssClass="testo_titolo"></asp:Label>
                                          </th>                                             
                                           <th id="Th11" runat="server" align="left">
                                              <asp:Label ID="LblRiferimento" runat="server" Text="Disp.Nolo" CssClass="testo_titolo"></asp:Label>
                                          </th> 
                                          <th></th>                                       
                                      </tr>
        ...
        <asp:SqlDataSource ID="SqlRifornimenti" runat="server" 
            ...
            SelectCommand="SELECT lavaggi.id, stazioni.nome_stazione, veicoli.targa, MODELLI.descrizione, MODELLI.capacita_serbatoio, alimentazione.descrizione AS Alimentazione, 
                          ...
                          WHERE (1 = 1) AND rifornimenti.data_uscita_parco is null ">
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlStazioni" runat="server" 
            ConnectionString="<%$ ConnectionStrings:SicilyConnectionString %>" 
            SelectCommand="SELECT stazioni.id, stazioni.nome_stazione, (codice + ' ' + nome_stazione) As stazione FROM stazioni WITH(NOLOCK) WHERE attiva='1' ORDER BY codice">
          </asp:SqlDataSource>
