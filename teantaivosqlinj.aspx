<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageNoMenuSqlInj.master" AutoEventWireup="false" CodeFile="teantaivosqlinj.aspx.vb" Inherits="teantaivosqlinj" %>
            ...
            <tr>
                <td align=center>
                    <asp:Label ID="lblTesto" runat="server" 
                        Text="A T T E N Z I O N E  ( TENTATIVO ATTACCO SQL Injection )" 
